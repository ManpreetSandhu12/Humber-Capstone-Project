...
//  Quiz2
//
//  Created by gurpreet kaur on 13/4/18.
//  Copyright © 2018 Kaur Gurpreet. All rights reserved.
//
...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que2 = Question(imgName: "img1", questionText: "What is 4 + 2 ?", options: ["9", "4", "3", "6"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "img1", questionText: "What is 6 / 2 ?", options: ["2", "4", "3", "5"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "img1", questionText: "What is 2 - 2 ?", options: ["2", "4", "1", "0"], correctAns: 3, wrongAns: -1, isAnswered: false)
        ...
        let que7 = Question(imgName: "img2", questionText: "What type of animal is a seahorse?", options: ["Crustacean", "Arachnid", "Fish", "Shell"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que8 = Question(imgName: "img2", questionText: "What is the fastest water animal?", options: ["White with black stripes", "Black with white stripes", "Both of the above", "None of the above"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que9 = Question(imgName: "img2", questionText: "What color are zebras?", options: ["Porpoise", "Sailfish", "Flying fish", "Tuna"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que10 = Question(imgName: "img2", questionText: "Which of the following animals sleep standing up?", options: ["Gorillas", "Flamingos", "Camels", "Ravens"], correctAns: 1, wrongAns: -1, isAnswered: false)
